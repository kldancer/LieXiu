...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.liexiu.ai"
	cookieDomain string // cookie scope, e.g. ".liexiu.ai"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.liexiu.ai")
//   - COOKIE_DOMAIN           (e.g. ".liexiu.ai")
