...
// (LieXiu Cloud Node) PAT. Tokens with this prefix are validated by
// calling the LieXiu Cloud Fleet service rather than by hitting our
...
// LIEXIU_CLOUD_FLEET_URL configured simply rejects mcn_ tokens at
...
type CloudPATVerifierConfig struct {
	...
	// https://fleet.liexiu.cloud). Trailing slashes are trimmed.
