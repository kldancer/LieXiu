...
// in the liexiu binary. The daemon runs Prepare/Reuse in that subprocess so a
...
const PreparationHelperArg = "__liexiu_execenv_prepare"
...
// name the current liexiu binary followed by PreparationHelperArg in
