...
// loadTrustedProxies reads the same LIEXIU_TRUSTED_PROXIES env var the rest of
...
func loadTrustedProxies() []netip.Prefix {
	raw := strings.TrimSpace(os.Getenv("LIEXIU_TRUSTED_PROXIES"))
	if raw == "" {
		return nil
	}
...
// shared LIEXIU_TRUSTED_PROXIES value in here at startup.
