...
func TestRelativeWorkDir(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			workDir:  "/Users/alice/liexiu_workspaces/" + wsID + "/5c57b65b/workdir",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/alice/liexiu_workspaces/" + wsID + "/5c57b65b",
			wsID:     wsID,
			taskID:   taskID,
		...
		},
		{
			...
			workDir:  "/Users/df007df/code/work/projects/liexiu/foo",
			wsID:     wsID,
			taskID:   taskID,
			expected: "code/work/projects/liexiu/foo",
		},
		{
		...
		},
		{
			...
			workDir:  `C:\Users\alice\liexiu_workspaces\` + wsID + `\5c57b65b\workdir`,
			wsID:     wsID,
			taskID:   taskID,
			expected: wsID + "/5c57b65b/workdir",
		},
		{
			...
			wsID:     "",
			taskID:   taskID,
			expected: "liexiu_workspaces/" + wsID + "/5c57b65b/workdir",
		},
		{
