...
func TestCanInvokeAgent_PublicToMemberWhitelist(t *testing.T) {
	...
	allowedMember := createPermissionTestMember(t, "perm-allowed-member@liexiu.test")
	otherMember := createPermissionTestMember(t, "perm-other-member@liexiu.test")
...
func TestCanInvokeAgent_MixedMemberAndTeamTargets(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-mix-a@liexiu.test")
	memberB := createPermissionTestMember(t, "perm-mix-b@liexiu.test")
...
func TestUpdateAgent_BatchReplaceOverlappingMembers(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-batch-a@liexiu.test")
	memberB := createPermissionTestMember(t, "perm-batch-b@liexiu.test")
	memberC := createPermissionTestMember(t, "perm-batch-c@liexiu.test")
...
func TestUpdateAgent_WorkspaceStacksWithMembersThenNarrowed(t *testing.T) {
	...
	memberA := createPermissionTestMember(t, "perm-stack-a@liexiu.test")
	memberB := createPermissionTestMember(t, "perm-stack-b@liexiu.test")
	...
	memberC := createPermissionTestMember(t, "perm-stack-c@liexiu.test")
	w := httptest.NewRecorder()
	r := newRequest("PUT", "/api/agents/"+agentID, map[string]any{
		"permission_mode": "public_to",
		"invocation_targets": []map[string]any{
...
func TestCreateAgent_EmptyPublicToNormalizesToWorkspace(t *testing.T) {
	...
	someMember := createPermissionTestMember(t, "perm-emptypublic-m@liexiu.test")
...
func TestCanInvokeAgent_SystemWorkspaceExceptionAndMemberFailClosed(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-sys-failclosed@liexiu.test")
...
func TestRevokeMember_ClearsInvocationTargets(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-revoke-x@liexiu.test")
...
func TestRevokeMember_InvocationTargetCleanupIsWorkspaceScoped(t *testing.T) {
	...
	userX := createPermissionTestMember(t, "perm-xws@liexiu.test")
...
func TestUpdateAgent_AccessChangeIsOwnerOnly(t *testing.T) {
	...
	adminID := createPermissionTestAdmin(t, "perm-access-admin@liexiu.test")
...
func TestUpdateAgent_LegacyVisibilityNoOpForMemberOnlyPublicTo(t *testing.T) {
	...
	memberX := createPermissionTestMember(t, "perm-legacyvis-x@liexiu.test")
	agentID := createPublicToAgentWithTargets(t, "legacy-vis-member-only-agent", []map[string]any{
		{"target_type": "member", "target_id": memberX},
	})
	adminID := createPermissionTestAdmin(t, "perm-legacyvis-admin@liexiu.test")
