...
import (
	...
	"github.com/kailonyang/liexiu/server/internal/integrations/vcs"
...
func (h *Handler) ConnectVCS(w http.ResponseWriter, r *http.Request) {
	...
	if !h.isVCSConfigured() {
		writeError(w, http.StatusServiceUnavailable, "vcs integration not configured (LIEXIU_VCS_SECRET_KEY unset)")
		return
	}
