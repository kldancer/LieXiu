...
func TestAgentEnv_AgentOwnerMemberCanRevealAndUpdate(t *testing.T) {
	...
	agentID, ownerUserID := agentEnvOwnerFixture(t, "env-owner-member-agent", "env-owner-member@liexiu.test")
...
func TestAgentEnv_UnrelatedMemberForbidden(t *testing.T) {
	...
	agentID, _ := agentEnvOwnerFixture(t, "env-unrelated-target-agent", "env-target-owner@liexiu.test")
	strangerID := createPermissionTestMember(t, "env-stranger@liexiu.test")
...
func TestAgentEnv_WorkspaceRolesUnchanged(t *testing.T) {
	...
	agentID, _ := agentEnvOwnerFixture(t, "env-role-check-agent", "env-role-check-owner@liexiu.test")

	adminID := createPermissionTestMember(t, "env-admin@liexiu.test")
...
func TestAgentEnv_AgentActorRejectedForOwnedAgent(t *testing.T) {
	...
	targetID, ownerUserID := agentEnvOwnerFixture(t, "env-actor-target-agent", "env-actor-owner@liexiu.test")
