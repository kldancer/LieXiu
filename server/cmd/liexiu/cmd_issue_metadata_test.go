...
// Tests for `liexiu issue metadata list` 404-degradation behavior, plus
...
// endpoint working.
//
// Background: GitHub issue kailonyang/liexiu#3711 — on self-hosted
// backends that pre-date the per-issue metadata route, agent runtime
// bootstrap calls `liexiu issue metadata list <issue> --output json`
