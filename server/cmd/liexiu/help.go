...
var rootHelpTemplate = `Work seamlessly with LieXiu from the command line.

USAGE
  liexiu <command> <subcommand> [flags]
{{range .Groups}}
{{.Title}}
...
EXAMPLES
  ...
  $ liexiu daemon start
  $ liexiu agent list --output json

ENVIRONMENT VARIABLES
  LIEXIU_SERVER_URL    Override the default server URL
  LIEXIU_WORKSPACE_ID  Set the active workspace

LEARN MORE
  Use ` + "`liexiu <command> <subcommand> --help`" + ` for more information about a command.
`
