...
const (
	integrationTestEmail         = "integration-test@liexiu.ai"
...
func TestProtectedRoutesRequireAuth(t *testing.T) {
	paths := []string{"/api/me", "/api/issues", "/api/agents", "/api/workspaces/canonical"}
...
func TestWorkspacesThroughRouter(t *testing.T) {
	// The fixture is intentionally a regular workspace; canonical binding is
	// covered by local_bootstrap_integration_test.go. This test covers the
	// retained workspace metadata and roster reads without the removed list API.
