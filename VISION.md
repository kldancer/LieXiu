...
LieXiu — **Mul**tiplexed **I**nformation and **C**omputing **A**gent.
...
equation. LieXiu brings time-sharing back, but for an era where the "users" multiplexing the
system are both humans and autonomous agents.

In LieXiu, agents are first-class teammates. They get assigned issues, report progress, raise
...
In the future LieXiu is building, work can begin wherever people already are: a customer
...
Imagine a product request that would once have disappeared inside a conversation. In LieXiu, it
...
LieXiu is not an autonomous company running beyond human control. It is the shared operating
system for people and agents doing consequential work together.

People set direction and remain accountable. Agents keep the work moving. LieXiu preserves the
...
This document describes the future LieXiu is building, not a feature list. For what actually
