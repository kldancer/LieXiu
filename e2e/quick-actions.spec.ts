  ...
  try {
    ...
    await page.addInitScript(
      ({ authToken, activeSessionId }) => {
        localStorage.setItem("liexiu_token", authToken);
        localStorage.setItem("liexiu:chat:activeSessionId", activeSessionId);
        localStorage.setItem("liexiu:chat:isOpen", "false");
      },
