...
const WORKSPACE_SCOPED_KEYS = [
  "liexiu_issue_surface_views",
  "liexiu_issues_view",
  "liexiu_issues_scope",
  "liexiu_my_issues_view",
  "liexiu:chat:selectedAgentId",
  "liexiu:chat:selectedProjectId",
  "liexiu:chat:activeSessionId",
  "liexiu:chat:expanded",
  "liexiu_navigation",
];
