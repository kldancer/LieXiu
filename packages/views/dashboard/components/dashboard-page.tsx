...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@liexiu/ui/components/ui/tabs";
import {
  CompactNumberFlow,
  CurrencyNumberFlow,
  NumberFlow,
...
const EMPTY_DAILY: import("@liexiu/core/types").DashboardUsageDaily[] = [];
const EMPTY_BY_AGENT: import("@liexiu/core/types").DashboardUsageByAgent[] = [];
const EMPTY_RUNTIME: import("@liexiu/core/types").DashboardAgentRunTime[] = [];
const EMPTY_RUNTIME_DAILY: import("@liexiu/core/types").DashboardRunTimeDaily[] = [];
const EMPTY_FAILURE_DAILY: import("@liexiu/core/types").DashboardFailureDaily[] = [];
const EMPTY_FAILURE_BY_AGENT: import("@liexiu/core/types").DashboardFailureByAgent[] =
  [];
