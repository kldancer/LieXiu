...
vi.mock("@liexiu/core/github", async () => {
  const actual =
    await vi.importActual<typeof import("@liexiu/core/github")>("@liexiu/core/github");
  return {
    ...actual,
...
describe("GitHubTab", () => {
  ...
  it("clicking Disconnect opens the confirmation and only fires on confirm", async () => {
    ...
    expect(screen.getByText(/LieXiu will stop receiving webhooks/i)).toBeTruthy();
