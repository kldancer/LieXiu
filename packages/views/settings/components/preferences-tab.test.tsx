...
vi.mock("@liexiu/core/i18n/react", async () => {
  const actual =
    await vi.importActual<typeof import("@liexiu/core/i18n/react")>(
      "@liexiu/core/i18n/react",
    );
  return {
    ...actual,
    useLocaleAdapter: () => ({
...
vi.mock("@liexiu/core/auth", async () => {
  const actual =
    await vi.importActual<typeof import("@liexiu/core/auth")>(
      "@liexiu/core/auth",
    );
  type AuthState = {
...
import { useCommentComposerStore } from "@liexiu/core/issues/stores";
