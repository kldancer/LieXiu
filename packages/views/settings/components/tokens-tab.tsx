...
import type { PersonalAccessToken } from "@liexiu/core/types";
import { Alert, AlertDescription } from "@liexiu/ui/components/ui/alert";
...
import { Card, CardContent } from "@liexiu/ui/components/ui/card";
import {
  Select,
  SelectTrigger,
  SelectValue,
...
export function TokensTab() {
  ...
  const handleCopyCommand = async () => {
    if (!newToken) return;
    if (await copyText(`liexiu login --token ${newToken}`)) {
