...
import type { RuntimeModelThinkingLevel } from "@liexiu/core/types";
 ...
 * the user's local CLI install, not by LieXiu's catalog.
 */
      ...
      {levels.map((l) => (
        ...
        >
          ...
          {/* No model-factory-default badge here on purpose: when the
              picker is "Follow CLI config" (value === ""), LieXiu omits
