 ...
 * side by side is what makes the destructive one legible.
 *
...
export function CreateAgentFooter({
  ...
  const { t } = useT("agents");
  return (
    <div className="sticky bottom-0 mt-8 flex items-center justify-between gap-3 border-t bg-background/95 py-3 pl-5 backdrop-blur">
      {error ? (
        <p
          role="alert"
