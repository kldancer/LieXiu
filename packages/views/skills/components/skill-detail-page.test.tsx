...
vi.mock("@liexiu/core/hooks", () => ({ useWorkspaceId: () => "ws-1" }));
...
vi.mock("@liexiu/core/workspace/avatar-url", () => ({
...
vi.mock("@liexiu/ui/components/common/capability-banner", () => ({
  CapabilityBanner: () => <div data-testid="capability-banner" />,
}));
vi.mock("@liexiu/ui/components/common/actor-avatar", () => ({
  ActorAvatar: () => <div />,
}));
