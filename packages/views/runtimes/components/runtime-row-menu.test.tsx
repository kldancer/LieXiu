...
import type { AgentRuntime, RuntimeProfile } from "@liexiu/core/types";
...
vi.mock("@liexiu/core/runtimes/mutations", () => ({
...
describe("runtime list CLI column", () => {
  ...
  // shared liexiu daemon `cli_version`. It must instead show the agent's own
