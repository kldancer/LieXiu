...
import { chatKeys } from "@liexiu/core/chat/queries";
...
vi.mock("@liexiu/core/chat/queries", async () => {
  const actual = await vi.importActual<typeof import("@liexiu/core/chat/queries")>(
    "@liexiu/core/chat/queries",
  );
  return {
    ...actual,
...
vi.mock("@liexiu/ui/components/ui/popover", async () => {
