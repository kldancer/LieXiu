...
import { useCommentComposerStore, useCommentDraftStore } from "@liexiu/core/issues/stores";
...
vi.mock("@liexiu/core/hooks/use-file-upload", async () => ({
  ...(await vi.importActual<typeof import("@liexiu/core/hooks/use-file-upload")>(
    "@liexiu/core/hooks/use-file-upload",
  )),
