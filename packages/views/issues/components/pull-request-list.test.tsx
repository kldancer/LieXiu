...
import type { GitHubPullRequest } from "@liexiu/core/types";
import enCommon from "../../locales/en/common.json";
import enIssues from "../../locales/en/issues.json";

const TEST_RESOURCES = { en: { common: enCommon, issues: enIssues } };

vi.mock("@liexiu/core/github/queries", async () => {
  const actual = await vi.importActual<typeof import("@liexiu/core/github/queries")>(
    "@liexiu/core/github/queries",
  );
  return {
    ...actual,
