...
import type { WorkingAgentSummary } from "@liexiu/core/types";
...
vi.mock("@liexiu/ui/components/ui/hover-card", () => ({
...
vi.mock("@liexiu/ui/components/ui/button", async () => {
  const actual =
    await vi.importActual<typeof import("@liexiu/ui/components/ui/button")>(
      "@liexiu/ui/components/ui/button",
    );
  return {
    ...actual,
