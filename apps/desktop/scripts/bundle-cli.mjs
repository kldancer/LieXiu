#!/usr/bin/env node
// Builds the `liexiu` CLI from server/cmd/liexiu and copies the binary
...
//
// ldflags mirror `make build` so `liexiu --version` reports a meaningful
// version / commit / date.
//
...
function binaryNameForPlatform(platform) {
  return platform === "win32" ? "liexiu.exe" : "liexiu";
}
