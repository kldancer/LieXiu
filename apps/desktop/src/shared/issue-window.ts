export const ISSUE_WINDOW_ARGUMENT_PREFIX = "--liexiu-issue-window=";
...
export function parseIssueWindowPath(
  ...
  let url: URL;
  try {
    url = new URL(value, "https://desktop.liexiu.invalid");
  } catch {
    return null;
  }
  if (url.origin !== "https://desktop.liexiu.invalid") return null;
