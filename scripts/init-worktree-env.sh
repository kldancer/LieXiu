...
postgres_db="liexiu_${slug}_${offset}"
postgres_port=5432
...
DATABASE_URL=postgres://liexiu:liexiu@localhost:${postgres_port}/${postgres_db}?sslmode=disable

PORT=${backend_port}
JWT_SECRET=change-me-in-production
LIEXIU_OWNER_BOOTSTRAP_SECRET=change-me-in-development
LIEXIU_SERVER_URL=ws://localhost:${backend_port}/ws
LIEXIU_PUBLIC_URL=http://localhost:${backend_port}
